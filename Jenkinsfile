            ...
            steps{
                ...
                withCredentials([
                    ...
                    script {
                        ...
                        def copyService = "sudo cp harbour-2024-sample/service /etc/systemd/system/harbour-2024-sample.service"
                        def startService = "sudo systemctl start harbour-2024-sample"
                        def stopIfRunning = "sudo systemctl stop harbour-2024-sample"
